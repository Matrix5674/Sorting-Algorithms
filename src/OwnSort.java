    ...
    public static int[] OwnSort(int[] t_arr) {
        ...
        while(ptr_1 <= ptr_2) {
            if (arr[ptr_1] >= arr[pivot_Index] && arr[ptr_2] <= arr[pivot_Index])
                if (ptr_1 == 0) pivot_Index = ptr_2;
                if (ptr_2 == 0) pivot_Index = ptr_1;
        ...
        System.arraycopy(subArrayLeft, 0, combinedArray, 0, subArrayLeft.length);
        System.arraycopy(subArrayRight, 0, combinedArray, subArrayLeft.length, subArrayRight.length);
